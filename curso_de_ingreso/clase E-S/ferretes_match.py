...
marca_lampara = input("Ingrese la marca de lamparas a comprar: ")

# def descuento_por_cantidad(cantidad_comprada):
...
# elif cantidad_comprada == 4:
#     if marca_lampara == 1 or marca_lampara == 2:
#         porcentaje_descuento = 25
#     else:
#         porcentaje_descuento = 20

# elif cantidad_comprada == 3:
#     if marca_lampara == 1:
